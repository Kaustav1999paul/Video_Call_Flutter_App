...
class UniversalVariables {
  ...
  static final Color searchStart = Color(0xfff46b45);
  static final Color searchEnd = Color(0xffeea849);

  static final Color sendStart = Color(0xffff4b1f);
  static final Color sendEnd = Color(0xffff9068);
